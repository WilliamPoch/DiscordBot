 ...
 * =============================================================================
 */
import { InferenceModel, MetaGraphInfo, ModelPredictConfig, ModelTensorInfo, NamedTensorMap, Tensor } from '@tensorflow/tfjs';
 ...
 */
export declare function getMetaGraphsFromSavedModel(path: string): Promise<MetaGraphInfo[]>;
/**
 ...
 */
export declare function getInputAndOutputNodeNameFromMetaGraphInfo(savedModelInfo: MetaGraphInfo[], tags: string[], signature: string): string[][];
/**
...
export declare class TFSavedModel implements InferenceModel {
    ...
    private backend;
    private disposed;
    constructor(sessionId: number, jsid: number, inputNodeNames: string[], outputNodeNames: string[], backend: NodeJSKernelBackend);
    /**
